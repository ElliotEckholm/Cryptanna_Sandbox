...
import {AggressiveBotClass} from '../scripts/Bots_Database.js';
...
export default class SelectMarket extends Component {
  ...
  _onImplementBot = () => {
    ...
    let bot = new AggressiveBotClass(params.exchange,params.marketName,false, params.marketBalance, this.state.btc_amount, this.state.usd_amount);
  ...
  render() {
    ...
    return (
      <View style={Styles.container}>
        ...
        <View >
          <Text style={Styles.title}>{'Aggressive Bot \n' +params.marketName+' Market'} </Text>
