...
import styles from '../styles/Manual_SellLimitOrderButton.style.js';
import ccxt from 'ccxt';

/////////////Functionality imports//////////
import {limitSellOrder,limitBuyOrder,fetchBalance,fetchTicker, sandbox_exchange} from '../scripts/ccxt.js';
...
export default class Manual_LimitOrderButton extends Component {
    ...
    _onBuy = () => {
        limitSellOrder(this.state.exchange, this.state.market, this.state.want_to_buy,  this.state.your_price);
